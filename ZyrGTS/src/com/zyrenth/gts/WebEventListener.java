...
public interface WebEventListener {
	 ...
	 * 
	 * @param e
	 *            A ServerStatusEvent object that contains details about the
	 *            server's new status
	 */
	 ...
	 * 
	 * @param e
	 *            A PokemonReceivedEvent object that contains the Pokemon that
	 *            was received, the Trainer that sent it, and the PID of the
	 *            game it was sent from.
	 */
	 ...
	 * 
	 * @param e
	 *            A PokemonSentEvent object that contains the Pokemon that was
